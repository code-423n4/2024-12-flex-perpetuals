...
library Deployer {
        ...
        return
            IEcoPythCalldataBuilder3(
                deployContractWithArguments(
                    ...
                    abi.encode(_ecoPyth, _ocLens, _cLens, _l2BlockNumber)
                )
            );
    }
    ...
    function deployCrossMarginHandler(
        ...
        bytes memory _logicBytecode = abi.encodePacked(
            vm.getCode("./out/CrossMarginHandler.sol/CrossMarginHandler.json")
        );
        bytes memory _initializer = abi.encodeWithSelector(
    ...
    function deployLiquidityHandler02(
        ...
        bytes memory _logicBytecode = abi.encodePacked(
            vm.getCode("./out/LiquidityHandler02.sol/LiquidityHandler02.json")
        );
        bytes memory _initializer = abi.encodeWithSelector(
            bytes4(keccak256("initialize(address,address,uint256)")),
            _liquidityService,
    ...
    function deployLimitTradeHandler(
        ...
        bytes memory _logicBytecode = abi.encodePacked(
            vm.getCode("./out/LimitTradeHandler.sol/LimitTradeHandler.json")
        );
        bytes memory _initializer = abi.encodeWithSelector(
    ...
    function deployTradingStakingHook(
        ...
        bytes memory _logicBytecode = abi.encodePacked(
            vm.getCode("./out/TradingStakingHook.sol/TradingStakingHook.json")
        );
        bytes memory _initializer = abi.encodeWithSelector(
            bytes4(keccak256("initialize(address,address)")),
            _tradingStaking,
    ...
    function deployCrossMarginService(
        ...
        bytes memory _logicBytecode = abi.encodePacked(
            vm.getCode("./out/CrossMarginService.sol/CrossMarginService.json")
        );
        bytes memory _initializer = abi.encodeWithSelector(
            bytes4(keccak256("initialize(address,address,address,address)")),
            _configStorage,
    ...
    function deployLiquidationService(
        ...
        bytes memory _logicBytecode = abi.encodePacked(
            vm.getCode("./out/LiquidationService.sol/LiquidationService.json")
        );
        bytes memory _initializer = abi.encodeWithSelector(
            bytes4(keccak256("initialize(address,address,address,address)")),
            _perpStorage,
    ...
    function deployStakedGlpStrategy(
        ...
        bytes memory _logicBytecode = abi.encodePacked(
            vm.getCode("./out/StakedGlpStrategy.sol/StakedGlpStrategy.json")
        );
        bytes memory _initializer = abi.encodeWithSelector(
            bytes4(keccak256("initialize(address,(address,address,address,address,address),address,uint16)")),
            _sGlp,
