...
contract TradeService_FundingFee is TradeService_Base {
    ...
    function testCorrectness_fundingFee() external {
        ...
        vm.warp(21001);
        {
            ...
            IPerpStorage.Position memory alicePosition = perpStorage.getPositionById(
                getPositionId(ALICE, 0, ethMarketIndex)
            );
            ...
            IPerpStorage.Position memory bobPosition = perpStorage.getPositionById(
                getPositionId(BOB, 0, ethMarketIndex)
            );
