...
contract TC36 is BaseIntTest_WithActions {
    function testCorrectness_TC36_MaxUtilization() external {
...

        {
            ...
            assertApproxEqRel(
                _maxUtilizationValue,
                1675200000000000000000000000000000000,
                MAX_DIFF,
                "MaxUtilizationValue"
            );
        }
        ...
        );
        {
            ...
            assertApproxEqRel(
                calculator.getHLPValueE30(false),
                2094997200000000000000000000000000000,
                MAX_DIFF,
                "hlp TVL"
            );
        ...
        );
        {
            ...
            assertApproxEqRel(
                calculator.getHLPValueE30(false),
                2094363472200000000000000000000000000,
                MAX_DIFF,
                "hlp TVL"
            );
...

        {
            ...
            assertApproxEqRel(
                _maxUtilizationValue,
                1675490777760000000000000000000000000,
                MAX_DIFF,
                "MaxUtilizationValue"
            );
        }
