...
contract Calculator is OwnableUpgradeable, ICalculator {
    ...
    function _getFeeBPS(
        ...
        uint256 withdrawalWeightDiff = _hlpTokenConfig.targetWeight > _hlpTokenConfig.maxWeightDiff
            ...
            : 0;
        if (
            _nextWeight > _hlpTokenConfig.targetWeight + _hlpTokenConfig.maxWeightDiff ||
            _nextWeight < withdrawalWeightDiff
        ) {
    ...
    function _getCollateralValue(
        ...
        for (uint256 i; i < traderTokenLen; ) {
            ...
            ConfigStorage.CollateralTokenConfig memory _collateralTokenConfig = _var
                .configStorage
            ...
            _collateralValueE30 +=
                (_var.amount * _var.priceE30 * _var.collateralFactorBPS) /
                ((10 ** _var.decimals) * BPS);
    ...
    function getBorrowingFee(
        ...
        PerpStorage.AssetClass memory _assetClassState = PerpStorage(perpStorage).getAssetClassByIndex(
            _assetClassIndex
        );
        // // Calculate borrowing fee.
